...
```
\
:red_circle: Write your own code to read in your data into a tibble called `msoa_measure` that includes the two columns `area_code` and `measure`. 
\
